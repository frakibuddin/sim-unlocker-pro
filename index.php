        ...
        <div class="row align-items-center">
            <div class="col-md-6 scrolled fade-in">
                <div class="hero-texts">
                    ...
                    <div class="d-flex align-items-center gap-4 justify-content-lg-start justify-content-md-start justify-content-center">
                        <a href="" class="mybtn dark-btn d-flex align-items-center gap-3"> <i class="fa-solid fa-arrow-right-to-bracket "></i>
                            Registration</a>
                        <a href="" class="mybtn white-btn d-flex align-items-center gap-3 "> <i class="fa-solid fa-lock"></i>
                            Sign in</a>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <svg class="stage-line-svg d-lg-block d-md-block d-none js-scroll" width="432" height="125" fill="none">
                <path d="M1.633 1.29c.308 12.988-3.497 38 10.01 54.328 14.885 19.842 32.162 24.39 52.725 28.521 36.088 7.25 72.202 8.779 109.27 1.774 11.033-2.085 21.968-8.278 32.723-12.617 11.066-4.465 22.127-8.914 33.321-12.404 23.822-7.426 47.443-7.882 71.079-5.229 20.514 2.303 41.669 2.608 61.157 11.122 30.981 6.832 49.838 47.155 58.34 57.199" stroke="#F0B9DD" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="4 8 4 8"></path>
            </svg>
        </div>
        <div class="row align-items-center ">
            ...
            <svg class="stage-line-svg d-lg-block d-md-block d-none js-scroll" width="100%" height="268.09px" fill="none" data-reveal="in-fade">
        ...
        <div class="row align-items-center">
            ...
            <svg class="stage-line-svg d-lg-block d-md-block d-none js-scroll" width="100%" height="100%" style="margin-left: 28%;" fill="none" data-reveal="in-fade">
                <path d="M1 1c7.255 23.316 12.132 49.428 31.848 67.45 11.32 10.349 16.684 18.72 32.52 24.395 13.96 5.003 51.325 18.606 66.469 5.364 7.463-6.526 16.624-20.318 3.781-26.82-6.446-3.262-17.016-2.214-24.201-1.616-5.314.443-6.954 5.964-8.739 9.258-5.374 9.922-2.814 24.311 4.874 32.256 17.363 17.942 41.593 32.2 69.242 35.71 22.248 2.823 45.197 1.977 67.561 4.041 34.213 3.157 70.887 7.217 104.031 15.577 18.72 4.721 37.381 9.547 56.133 14.18 10.798 2.669 27.801 6.337 37.726 11.137C463.073 201.574 473.557 214.827 479 218" stroke="#AAD1B6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="4 8 4 8"></path>
            </svg>
        ...
        <div class="row align-items-center ">
            ...
            <div class="col-md-6 text-lg-start text-md-start text-center">
                <div class="num-list m-md-center js-scroll slide-right">
                    <h2>4</h2>
                    <svg class="dark-opacity-100" width="100%" height="100%" viewBox="0 0 602 473" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M290.806 463.188C374.905 469.353 468.778 492.629 529.757 434.517C597.098 370.239 616.804 266.193 591.202 177.098C566.996 92.3192 491.898 30.0454 407.023 5.07419C335.338 -15.8893 270.48 32.9741 202.363 62.8779C128.971 95.248 31.0635 104.651 6.54775 180.797C-18.899 259.873 34.0116 342.956 93.1287 401.839C144.488 453.014 218.345 457.793 290.806 463.188Z" fill="#309ee8"></path>
                    </svg>
                </div>
